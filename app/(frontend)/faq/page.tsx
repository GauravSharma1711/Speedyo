...
const faqs = {
  ...
  "For Sellers": [
    ...
    },
    {
      ...
      answer:
        "Private sellers can list a single vehicle for a one-time fee of  ¥8,000. Dealerships have monthly subscription plans with different listing limits and features. For our Managed Sale service, we add a 6% service fee to your asking price, which is paid by the buyer.",
    },
  ],
} as const;
