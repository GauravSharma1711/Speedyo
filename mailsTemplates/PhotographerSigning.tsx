interface PhotographerSendAgreementEmailProps {
...
export default function PhotographerSendAgreementEmail({
  position_title,
  fixed_percentage,
  agreement_url,
  agreement_id,
}: PhotographerSendAgreementEmailProps): string {
...
<head>
  ...
  <title>Speedyo Photographer Partnership</title>
</head>
          ...
          <tr>
            <td style="background-color:#ffffff; border-radius:0 0 10px 10px; padding:32px 40px 36px; border:1px solid #e5e7eb; border-top:none;">
              ...
              <p style="margin:0 0 24px; font-size:15px; color:#374151; line-height:1.7;">
                We're excited to invite you to become a photographer for Speedyo! Our platform connects skilled automotive photographers with dealerships and sellers.
              </p>
                ...
                <tr>
                  <td style="background-color:#f8fafc; border:1px solid #e5e7eb; border-radius:8px; padding:20px 24px;">
                    ...
                    <p style="margin:0; font-size:15px; color:#374151;">
                      <strong>Minimum Photos:</strong> 5 high-resolution photos per vehicle
                    </p>
                  </td>
                </tr>
              </table>
