interface DealershipSendAgreementEmailProps {
...
export default function DealershipSendAgreementEmail({
  dealership_name,
  representative_name,
  service_fee_amount,
  agreement_url,
  agreement_id,
}: DealershipSendAgreementEmailProps): string {
...
<head>
  ...
  <title>Speedyo Managed Sales Agreement</title>
</head>
          ...
          <tr>
            <td style="background-color:#ffffff; border-radius:0 0 10px 10px; padding:32px 40px 36px; border:1px solid #e5e7eb; border-top:none;">
              ...
              <p style="margin:0 0 24px; font-size:15px; color:#374151; line-height:1.7;">
                Your managed sales service agreement for <strong>${dealership_name}</strong> is ready for your review and signature. This agreement will allow you to list vehicles on our platform with our managed sales service.
              </p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:28px;">
                <tr>
                  <td style="background-color:#f8fafc; border:1px solid #e5e7eb; border-radius:8px; padding:20px 24px;">
                    ...
                    <p style="margin:0 0 10px; font-size:15px; color:#374151;">
                      <strong>Service Type:</strong> Managed Sales — Speedyo handles the entire sale process
                    </p>
              ...
              <p style="margin:0 0 24px; font-size:15px; color:#374151; line-height:1.7;">
                Click the button below to review the full agreement and submit your signature:
              </p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:28px;">
                <tr>
                  <td align="center">
                    <a href="${signingUrl}" style="display:inline-block; background:linear-gradient(135deg, #2563eb 0%, #10b981 100%); color:#ffffff; padding:14px 32px; text-decoration:none; border-radius:8px; font-weight:700; font-size:15px;">
